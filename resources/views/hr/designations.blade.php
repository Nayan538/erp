    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Designations</div>
            </div>
        ...
        <div class="modal-content">
            ...
            <form action="#" method="post">
                <div class="modal-body">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <input type="text" name="designationName" class="form-control" placeholder="Designation Name *" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect">Save Designation</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form action="#" method="post">
                <div class="modal-body">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <input type="text" name="designationName" id="designationName" class="form-control" placeholder="Designation Name *" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-danger mt-2 mb-2 btn-no-effect" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect">Update Designation</button>
                </div>
            </form>
        </div>
    </div>
