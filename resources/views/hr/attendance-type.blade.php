@extends('layout.app')
@section('content')
@section('title'){{'Attendance Types'}} @endsection
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    <div class="page-title">Attendance Types</div>

                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-ite"><a href="#">Dashboard</a></li>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Attendance Types</div>
            </div>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="createModalLabel">
                <h5 class="modal-title">Create Attendance Type</h5>
            ...
            <form action="#" method="post">
                <div class="modal-body">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <input type="text" name="typeName" class="form-control" placeholder="Attendance Type Name *" required>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form action="#" method="post">
                <div class="modal-body">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <input type="text" name="typeName" id="typeName" class="form-control" placeholder="Type Name *" required>
                        </div>
                    </div>
                </div>
