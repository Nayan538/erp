    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Create Purchase Order</div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="invoice-address-company-fields">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4 col-sm-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button class="btn btn-sm btn-info" type="button" title="Add New Company" data-bs-toggle="modal" data-bs-target="#createVendorModal">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button class="btn btn-sm btn-info" type="button" title="Add New Vendor KAM" data-bs-toggle="modal" data-bs-target="#createVendorKamModal">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <div class="col-md-4 col-sm-12">
                                                ...
                                                <input type="text" name="lotNo" value="B1001" class="form-control form-control-sm" id="lotNo" disabled="disabled">
                                            </div>
                                            <div class="col-md-4 col-sm-12">
...
<!-- Create Vendor KAM Modal -->
<div class="modal fade inputForm-modal" id="createVendorKamModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">

            <div class="modal-header" id="createModalLabel">
                <h5 class="modal-title">Create Vendor Profile</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
            </div>
            <form action="#" method="post">
                <div class="modal-body">
