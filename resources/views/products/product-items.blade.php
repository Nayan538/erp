        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    ...
                    <div class="page-title">Product Items</div>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Product Items</div>
            </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <select name="productCategoryId" class="form-control tom-select" required>
                                <option disabled="disabled" selected>Choose Product Category</option>
        ...
        <div class="modal-content">
            ...
            <form action="#" method="post">
                <div class="modal-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <select name="unitId" id="unitId" class="form-control tom-select" required>
                                <option selected disabled="disabled">Choose Product Unit *</option>
                                <option>Pcs</option>
                                <option>Kg</option>
                                <option>QuM</option>
                            </select>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-danger mt-2 mb-2 btn-no-effect" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect">Update Product</button>
                </div>
            </form>
        </div>
    </div>
