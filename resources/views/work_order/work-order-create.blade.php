@extends('layout.app')
@section('content')
@section('title'){{'Create Work Order'}} @endsection
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    ...
                    <div class="page-title">Create Work Order</div>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Create Work Order</div>
            </div>
        </div>
    </div>
...
<!--                                    </div>-->
                                    <div class="form-group row mt-2">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <label for="deliveryDate" class="col-form-label col-form-label-sm">Estimaetd Delivery Date *</label>
                                            <input name="deliveryDate" value="" id="deliveryDate" class="form-control form-control-sm datepicker flatpickr flatpickr-input active" type="text" placeholder="Select Estimated Delivery Date..">
                                        </div>
                                        <div class="col-md-4 col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="text-end mt-4">
                        <a href="javascript:void(0);" class="btn btn-success">Save Work Order</a>
                    </div>
                </div>
            </div>
