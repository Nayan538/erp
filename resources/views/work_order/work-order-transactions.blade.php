@extends('layout.app')
@section('content')
@section('title'){{'Work Order Transactions'}} @endsection
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    ...
                    <div class="page-title">Work Order Transactions</div>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Work Order Transactions</div>
            </div>
        </div>
    </div>
        ...
        <div class="widget-content widget-content-area br-8">
            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                ...
                <tr>
                    ...
                    <td>$ 4,34,500</td>
                    <td>Cash</td>
                    <td>BRAC Bank / 3345 5756 756 444</td>
                    <td>Paid</td>
                    <td>
                        <a href="work-order-receipt.php" class="bs-tooltip me-2 text-primary"
                           data-toggle="tooltip" data-placement="top" title="View Receipt">
        ...
        <div class="modal-content">
            ...
            <form action="#" method="post">
                <div class="modal-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <select name="trxType" class="form-select" required>
                                <option>Choose Payment Channel</option>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <select name="cashAccountId" class="form-select" required>
                                <option>Choose Cash Account</option>
                                <option value="">bKash / 01224356756</option>
                                <option value="">BRAC Bank / 4534 5345 545 656</option>
                                <option value="">Nagad / 01234565563 </option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <select name="trxType" class="form-select" required>
                                <option>Choose Transaction Status</option>
