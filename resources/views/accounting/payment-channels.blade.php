@extends('layout.app')
@section('content')
@section('title'){{'Payment Channels'}} @endsection
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    <div class="page-title">Payment Channels</div>

                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item "><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item "><a href="#">Settings</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Payment Channels</li>
                        </ol>
                    </nav>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Payment Channels</div>
            </div>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="createModalLabel">
                <h5 class="modal-title">Create Payment Channel</h5>
            ...
            <form action="#" method="post">
                <div class="modal-body">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <input type="text" name="channelName" class="form-control" placeholder="Payment Channel Name *" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect">Save Channel</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form action="#" method="post">
                <div class="modal-body">
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <input type="text" name="channelName" id="channelName" class="form-control" placeholder="Payment Channel Name *" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-danger mt-2 mb-2 btn-no-effect" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect">Update Channel</button>
                </div>
            </form>
        </div>
    </div>
