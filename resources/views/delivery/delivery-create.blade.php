@extends('layout.app')
@section('content')
@section('title'){{'Create WO Delivery'}} @endsection
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    ...
                    <div class="page-title">Create WO Delivery</div>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Create WO Delivery</div>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4 col-sm-12">
                                                ...
                                                <select name="orderNo" id="orderNo" class="form-control form-control-sm tom-select">
                                                    ...
                                                    <option selected>WO-1001</option>
                                                    <option>WO-1002</option>
                                                    <option>WO-1003</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 col-sm-12">
