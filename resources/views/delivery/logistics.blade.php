@extends('layout.app')
@section('content')
@section('title'){{'Logistic Companies'}} @endsection
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    ...
                    <div class="page-title">Logistic Companies</div>

                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item "><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item "><a href="#">Delivery</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Logistic Companies</li>
                        </ol>
                    </nav>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Logistics Companies</div>
            </div>
        ...
        <div class="widget-content widget-content-area br-8">
            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                ...
                <tr>
                    ...
                    <th>Company KAM Name</th>
                    <th>Company KAM Contact</th>
                ...
                <tr>
                    ...
                    <td>Maniknagar, Dhaka, Bangladesh</td>
                    <td>Yeasin Hazari</td>
                    <td>880123334535</td>
                    <td>
                        <a href="javascript:void(0);" class="action-btn btn-edit bs-tooltip me-2 text-success"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" id="editModalLabel">
                <h5 class="modal-title">Edit Logistic Company</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
            </div>
            <form action="#" method="post">
                <div class="modal-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <textarea name="companyAddress" class="form-control" id="companyAddress" placeholder="Company Address"></textarea>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <input type="text" name="KAMName" class="form-control" id="KAMName" placeholder="Company KAM Name *" required>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <input type="text" name="KAMContactNo" class="form-control" id="KAMContactNo" placeholder="KAM Contact No *" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-danger mt-2 mb-2 btn-no-effect" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect">Update Logistic Company</button>
                </div>
            </form>
        </div>
    </div>
